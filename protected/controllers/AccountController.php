	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('createLoanApplication', 'viewLoanApplication', 'viewLoans', 'indexLoanApplications'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('create', 'update', 'admin','delete','createBankAccount', 'manageLoanApplication'),
				'users'=>array('admin'),
			),
